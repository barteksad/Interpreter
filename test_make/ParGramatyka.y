...
Program
  : ListStmt { (fst $1, AbsGramatyka.Program (fst $1) (snd $1)) }

Stmt :: { (AbsGramatyka.BNFC'Position, AbsGramatyka.Stmt) }
Stmt
  : Type ListItem ';' { (fst $1, AbsGramatyka.Decl (fst $1) (snd $1) (snd $2)) }
  | Type Ident '(' ListArg ')' FBlock { (fst $1, AbsGramatyka.FnDecl (fst $1) (snd $1) (snd $2) (snd $4) (snd $6)) }
...
Arg
  : Type Ident { (fst $1, AbsGramatyka.VArg (fst $1) (snd $1) (snd $2)) }
  | 'ref' Type Ident { (uncurry AbsGramatyka.BNFC'Position (tokenLineCol $1), AbsGramatyka.RArg (uncurry AbsGramatyka.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $3)) }

Ret :: { (AbsGramatyka.BNFC'Position, AbsGramatyka.Ret) }
Ret
...
FBlock :: { (AbsGramatyka.BNFC'Position, AbsGramatyka.FBlock) }
FBlock
  : '{' ListStmt Ret '}' { (uncurry AbsGramatyka.BNFC'Position (tokenLineCol $1), AbsGramatyka.FBlock (uncurry AbsGramatyka.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $3)) }
...
Type
  ...
  | Type '(' ListAType ')' { (fst $1, AbsGramatyka.Fun (fst $1) (snd $1) (snd $3)) }

AType :: { (AbsGramatyka.BNFC'Position, AbsGramatyka.AType) }
AType
  : Type { (fst $1, AbsGramatyka.FArgV (fst $1) (snd $1)) }
  | 'ref' Type { (uncurry AbsGramatyka.BNFC'Position (tokenLineCol $1), AbsGramatyka.FArgR (uncurry AbsGramatyka.BNFC'Position (tokenLineCol $1)) (snd $2)) }
...
ListAType :: { (AbsGramatyka.BNFC'Position, [AbsGramatyka.AType]) }
ListAType
  : {- empty -} { (AbsGramatyka.BNFC'NoPosition, []) }
  | AType { (fst $1, (:[]) (snd $1)) }
  | AType ',' ListAType { (fst $1, (:) (snd $1) (snd $3)) }

Expr6 :: { (AbsGramatyka.BNFC'Position, AbsGramatyka.Expr) }
Expr6
  : '(' ListArg ')' '=>' Type FBlock { (uncurry AbsGramatyka.BNFC'Position (tokenLineCol $1), AbsGramatyka.LamDef (uncurry AbsGramatyka.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $5) (snd $6)) }
