...
instance Print (AbsGramatyka.Program' a) where
  prt i = \case
    AbsGramatyka.Program _ stmts -> prPrec i 0 (concatD [prt 0 stmts])
...
instance Print (AbsGramatyka.Stmt' a) where
  prt i = \case
    ...
    AbsGramatyka.FnDecl _ type_ id_ args fblock -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 fblock])
    ...
    AbsGramatyka.Incr _ id_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString "++"), doc (showString ";")])
    AbsGramatyka.Decr _ id_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString "--"), doc (showString ";")])
...
instance Print (AbsGramatyka.Arg' a) where
  prt i = \case
    AbsGramatyka.VArg _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_])
    AbsGramatyka.RArg _ type_ id_ -> prPrec i 0 (concatD [doc (showString "ref"), prt 0 type_, prt 0 id_])

instance Print (AbsGramatyka.Ret' a) where
  prt i = \case
...
instance Print (AbsGramatyka.FBlock' a) where
  prt i = \case
    AbsGramatyka.FBlock _ stmts ret -> prPrec i 0 (concatD [doc (showString "{"), prt 0 stmts, prt 0 ret, doc (showString "}")])
...
instance Print (AbsGramatyka.Type' a) where
  prt i = \case
    ...
    AbsGramatyka.Fun _ type_ atypes -> prPrec i 0 (concatD [prt 0 type_, doc (showString "("), prt 0 atypes, doc (showString ")")])

instance Print (AbsGramatyka.AType' a) where
  prt i = \case
    AbsGramatyka.FArgV _ type_ -> prPrec i 0 (concatD [prt 0 type_])
    AbsGramatyka.FArgR _ type_ -> prPrec i 0 (concatD [doc (showString "ref"), prt 0 type_])
...
instance Print (AbsGramatyka.Expr' a) where
  prt i = \case
    AbsGramatyka.LamDef _ args type_ fblock -> prPrec i 6 (concatD [doc (showString "("), prt 0 args, doc (showString ")"), doc (showString "=>"), prt 0 type_, prt 0 fblock])
