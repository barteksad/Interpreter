...
data Stmt' a
    ...
    | FnDecl a (Type' a) Ident [Arg' a] (FBlock' a)
    | Empty a
    | BStmt a (Block' a)
    | Ass a Ident (Expr' a)
    | Incr a Ident
...
type Ret = Ret' BNFC'Position
data Ret' a = Ret a (Expr' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type FBlock = FBlock' BNFC'Position
data FBlock' a = FBlock a [Stmt' a] (Ret' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Type' a = Int a | Str a | Bool a | Fun a (Type' a) [AType' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type AType = AType' BNFC'Position
data AType' a = FArgV a (Type' a) | FArgR a (Type' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Expr = Expr' BNFC'Position
data Expr' a
    = LamDef a [Arg' a] (Type' a) (FBlock' a)
    | EVar a Ident
    | ELitInt a Integer
    | ELitTrue a
    | ELitFalse a
...
instance HasPosition FBlock where
  hasPosition = \case
    FBlock p _ _ -> p
